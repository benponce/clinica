...
public class BluetoothLeService extends Service {
    ...
    public boolean initialize() {
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                Log.e(TAG, "No se pudo iniciar el BluetoothManager.");
                return false;
            }
        }
        ...
        if (mBluetoothAdapter == null) {
            Log.e(TAG, "No se pudo crear el BluetoothAdapter.");
            return false;
        }
    ...
    public boolean connect(final String address) {
        if (mBluetoothAdapter == null || address == null) {
            Log.w(TAG, "El adaptador no esta inicializado, o la dirección MAC es incorrecta.");
            return false;
        }
